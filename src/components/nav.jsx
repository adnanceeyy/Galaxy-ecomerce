  ...
  return (
    <div className="w-full flex justify-center fixed top-0 z-[100]">
      <nav className="w-[98%] h-10 md:h-20 mt-2 bg-[#f7fbff] text-[#080f30] border border-[#5555556b] flex items-center justify-between pr-1 rounded-[50px] shadow-2xl">
        <Link to="/">
          <img
            className="w-[55px] md:w-[130px]"
            src="./assets/images/logo.png"
            alt="logo"
          />
        </Link>

        <ul className="flex space-x-6 md:space-x-20 text-lg md:text-xl font-medium">
          {[
            { path: "/", label: "Home" },
      ...
      >
        ...
        <ul>
          ...
          <li className="border-b my-5 border-gray-400 text-gray-800">
            <Link to="/allproduct" onClick={closeNav}>Product</Link>
          </li>
          <li className="border-b my-5 border-gray-400 text-gray-800">
