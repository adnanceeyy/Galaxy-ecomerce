  ...
  return (
    <>
      ...
      <div className="w-[99.5%] mx-auto place-self-center rounded-[30px] md:rounded-[80px] bg-[#f7fbff] relative top-14 md:top-28 p-1 md:p-5 shadow-lg mb-56 md:mb-94 z-10">
        {product ? (
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-2 md:gap-4 mt-4 px-2 md:px-0 md:justify-center mb-6">
              <button className="bg-[#72c7ff] w-full rounded-[80px] py-2 font-bold text-lg md:text-2xl md:py-4 cursor-pointer hover:bg-[#1a90ff] hover:text-white transition">
                Buy Now
              </button>
              <button
        ...
        <div className="flex flex-col md:flex-row mx-10 rounded-[30px] group w-[96%] place-self-center md:w-[80%] bg-[#92d5f0] h-[480px] md:h-[400px] pb-2 mb-3 md:mb-20 mt-14 md:mt-28">
